...
<head>
	...
	<title><fmt:message key="errorJsp.titleOf403" /></title>
...
<p><fmt:message key="errorJsp.messageOf403" /></p>

<button class="pure-button pure-button-blue primary-cta" onClick="location.href = 'home.jsp?resourceAppId=${resourceAppId}'">
	<fmt:message key="errorJsp.returnHomeMsg" />
</button>

</div><!-- end contain -->
<p class="center"><fmt:message key="errorJsp.errorOf403" /></p>
